...
+ Add a new User. 
+ Under the user's name, 100 frames are captured to learn the new user's facial features.
+ Afterwards, the user is identified correctly by their name by matching the face with saved face data.
+ Attendance is marked in the pickle file with timestamp.
